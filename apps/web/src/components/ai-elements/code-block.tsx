...
export const CodeBlockContent = ({
  ...
  // The server's module-level token cache outlives requests, so SSR can emit
  // highlighted tokens while the client's first render (cold cache) emits raw
  // ones — a hydration mismatch. Render raw until hydration completes.
